...
{
    public class GlobalAvgPool2DLayer : GlobalAvgPool2DKernel, ILayer
    {
        ...
        {
            if (input == null)
                throw new Exception("GlobalAvgPool2DLayer: input is null.");
            else if (!(input is Data2D))
                throw new Exception("GlobalAvgPool2DLayer: input is not Data2D.");
