...
{
    [Serializable()]
    public class MinPool2DLayer : MinPool2DKernel, ILayer
    {

        public MinPool2DLayer(int paddingVertical, int paddingHorizontal,
        ...
        {
            if (input == null)
                throw new Exception("MinPool2DLayer: input is null.");
            else if (!(input is Data2D))
                throw new Exception("MinPool2DLayer: input is not Data2D.");
