...
{
    public class GlobalAvgPool1DLayer : GlobalAvgPool1DKernel, ILayer
    {
        ...
        {
            if (input == null)
                throw new Exception("GlobalAvgPool1DLayer: input is null.");
            else if (!(input is Data2D))
                throw new Exception("GlobalAvgPool1DLayer: input is not Data2D.");
