...
{
    [Serializable()]
    public class AvgPool2DLayer : AvgPool2DKernel, ILayer
    {

        public AvgPool2DLayer(int paddingVertical, int paddingHorizontal,
        ...
        {
            if (input == null)
                throw new Exception("AvgPool2DLayer: input is null.");
            else if (!(input is Data2D))
                throw new Exception("AvgPool2DLayer: input is not Data2D.");
