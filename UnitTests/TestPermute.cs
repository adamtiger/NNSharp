...
namespace UnitTests
{
    ...
    public class TestPermute
    {
        ...
        {
            string pathModel = Resources.TestsFolder + "test_permute_model.json";
            string pathInput = Resources.TestsFolder + "test_permute_input.json";
            string pathOutput = Resources.TestsFolder + "test_permute_output.json";
