...
namespace UnitTests
{
    ...
    public class TestSoftPlus
    {
        ...
        {
            string pathModel = Resources.TestsFolder + "test_softplus_model.json";
            string pathInput = Resources.TestsFolder + "test_softplus_input.json";
            string pathOutput = Resources.TestsFolder + "test_softplus_output.json";
