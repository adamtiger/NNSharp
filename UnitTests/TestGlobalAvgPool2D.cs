...
namespace UnitTests
{
    ...
    public class TestGlobalAvgPool2D
    {
        ...
        {
            string pathModel = Resources.TestsFolder + "test_globalavgpool_2D_model.json";
            string pathInput = Resources.TestsFolder + "test_globalavgpool_2D_input.json";
            string pathOutput = Resources.TestsFolder + "test_globalavgpool_2D_output.json";
