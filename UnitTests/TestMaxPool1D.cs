...
namespace UnitTests
{
    ...
    public class TestMaxPool1D
    {
        ...
        {
            string pathModel = Resources.TestsFolder + "test_maxpool_1D_1_model.json";
            string pathInput = Resources.TestsFolder + "test_maxpool_1D_1_input.json";
            string pathOutput = Resources.TestsFolder + "test_maxpool_1D_1_output.json";
        ...
        {
            string pathModel = Resources.TestsFolder + "test_maxpool_1D_2_model.json";
            string pathInput = Resources.TestsFolder + "test_maxpool_1D_2_input.json";
            string pathOutput = Resources.TestsFolder + "test_maxpool_1D_2_output.json";
