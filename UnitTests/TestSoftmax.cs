...
namespace UnitTests
{
    ...
    public class TestSoftmax
    {
        ...
        {
            string pathModel = Resources.TestsFolder + "test_softmax_model.json";
            string pathInput = Resources.TestsFolder + "test_softmax_input.json";
            string pathOutput = Resources.TestsFolder + "test_softmax_output.json";
