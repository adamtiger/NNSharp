...
namespace UnitTests
{
    ...
    public class TestGRU
    {
        ...
        {
            string pathModel = Resources.TestsFolder + "test_gru_model.json";
            string pathInput = Resources.TestsFolder + "test_gru_input.json";
            string pathOutput = Resources.TestsFolder + "test_gru_output.json";
