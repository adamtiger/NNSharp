...
namespace UnitTests
{
    ...
    public class TestSimpleRNN
    {
        ...
        {
            string pathModel = Resources.TestsFolder + "test_simplernn_model.json";
            string pathInput = Resources.TestsFolder + "test_simplernn_input.json";
            string pathOutput = Resources.TestsFolder + "test_simplernn_output.json";
