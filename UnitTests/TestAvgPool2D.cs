...
namespace UnitTests
{
    ...
    public class TestAvgPool2D
    {
        ...
        {
            string pathModel = Resources.TestsFolder + "test_avgpool_2D_1_model.json";
            string pathInput = Resources.TestsFolder + "test_avgpool_2D_1_input.json";
            string pathOutput = Resources.TestsFolder + "test_avgpool_2D_1_output.json";
        ...
        {
            string pathModel = Resources.TestsFolder + "test_avgpool_2D_2_model.json";
            string pathInput = Resources.TestsFolder + "test_avgpool_2D_2_input.json";
            string pathOutput = Resources.TestsFolder + "test_avgpool_2D_2_output.json";
